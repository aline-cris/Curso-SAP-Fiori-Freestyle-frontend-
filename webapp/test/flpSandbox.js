			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zovaline-display": {
								"semanticObject": "zovaline",
								"action": "display",
								"description": "App para gerenciar ordens de venda",
								"title": "App para gerenciar ordens de venda",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zovaline",
									"url": sap.ui.require.toUrl("zovaline")
								}
							}
						}
					}
